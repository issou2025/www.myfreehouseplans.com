...
def _select_settings_module() -> str:
    ...
    # Render commonly sets RENDER/RENDER_SERVICE_ID, and production always has DATABASE_URL.
    if os.getenv("RENDER") or os.getenv("RENDER_SERVICE_ID") or os.getenv("DATABASE_URL"):
        return "config.settings.prod"
